...
/*last_li_hide_new*/
    ...
    $(".last_li_hide_new").click(function(){
        $(".ak_pop").addClass("show_pop");
    });
    ...
    // });
     ...
     $(".cont_2").click(function(){
        $(".cont_2").addClass("cont_hide"); 
    });

     $(".cont_3").click(function(){
        $(".cont_3").addClass("cont_hide"); 
    });

     $(".cont_4").click(function(){
        $(".cont_4").addClass("cont_hide"); 
    });
   ...
   (function ($) {
    ...
    if ($('.compny_crsl').length) {
        var placeCarousel = $(".compny_crsl");
        placeCarousel.owlCarousel({
            loop: true,
            margin: 20,
            dots: false,
