                    ...
                    <tbody>
                        @foreach ($quotes as $index => $quote)
                            <tr>
                                ...
                                <td class="text-end">
                                    <!--  route('quote.detail', $quote->id) -->
                                    <a href="{{ route('quote.detail', $quote->id) }}" target="_blank" class="btn btn-primary fw-medium btn-sm d-inline-flex align-items-center justify-content-center gap-1">
